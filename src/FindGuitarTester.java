...
public class FindGuitarTester {
    ...
    /**
     * main function creates new inventory and initialise new object
     * whatErinLikes of class guitar. And the object is searched on the
     * inventory if the return type is not null it goes into if condition and
     * prints output.
     *
     * @param args
     */
    public static void main(String[] args) {
        ...
        // Creating new instance variable of class guitar.
        Guitar whatErinLikes = new Guitar("", 0, "fender", "Stratocastor",
                "electric", "Alder", "Alder");
        // whatErinLikes object is passed to search function
